...
//                     <span className="text-2xl select-none font-bold tracking-wide gradient-text">Admin Panel</span>
//                 </div>

//                 <nav className="flex-1 py-6 px-4 space-y-2">
//                     <Link href="/admin" className="block py-2 px-4 rounded hover:bg-gray-800 transition-colors nav-link" onClick={() => setOpen(false)}>
//                         Dashboard
//                     </Link>
...
//                         Devices
//                     </Link>
//                     <Link href="/admin/statistics" className="block py-2 px-4 rounded hover:bg-gray-800 transition-colors nav-link" onClick={() => setOpen(false)}>
//                         Statistics
//                     </Link>
//                     <Link href="/admin/profile" className="block py-2 px-4 rounded hover:bg-gray-800 transition-colors nav-link" onClick={() => setOpen(false)}>
//                         Profile
//                     </Link>
//                 </nav>
...
//                         >
//                             {(image && image !== "") ? <Image src={image} alt="Admin" width={100} height={100} /> : username[0]}
//                         </div>
//                         <div className="ml-3">
        ...
        <>
            ...
            >
                ...
                <nav className="flex-1 py-6 px-4 space-y-2">
                    ...
                    <Link href="/admin/devices" className="block py-2 px-4 rounded hover:bg-gray-800 transition-colors nav-link" onClick={() => setOpen(false)}>
                        Devices
                    </Link>
                    <Link href="/admin/statistics" className="block py-2 px-4 rounded hover:bg-gray-800 transition-colors nav-link" onClick={() => setOpen(false)}>
                        Statistics
